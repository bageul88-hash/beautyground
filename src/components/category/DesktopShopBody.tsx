...
import CategoryRecommend from '../home/CategoryRecommend'
...
// PC 쇼핑 화면 본문 — 2026-09-02 대표님 지시로 홈을 커뮤니티로 넘기면서,
// 기존 PC 홈의 상품 화면(히어로 배너·특가세일·추천·신상품)을 지우지 않고 이 파일로 옮겨왔다.
// 원래 주석: 「생방송 슬레이트」 기존 규칙 그대로(흰 배경+신호색 3개, 직각, 그림자 없음, tabular 숫자).
...
export default function DesktopShopBody({
  banners,
  categories,
  recommended,
  seasonLabel,
