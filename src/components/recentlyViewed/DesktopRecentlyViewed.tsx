...
import { IconClose, IconHome } from '../common/Icon'
import ImagePlaceholder from '../common/ImagePlaceholder'
import DesktopHeader from '../layout/DesktopHeader'
import type { RecentlyViewedLine } from '../../lib/recentlyViewed'

interface Props {
  loggedIn: boolean
  lines: RecentlyViewedLine[]
  onRemove: (line: RecentlyViewedLine) => void
}

// PC 버전 — 찜 목록(DesktopWishlist)과 동일한 4열 그리드 구조를 그대로 재사용.
export default function DesktopRecentlyViewed({ loggedIn, lines, onRemove }: Props) {
