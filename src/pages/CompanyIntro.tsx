...
const BUSINESS = [
  ...
  {
    no: '02',
    title: '백화점 현장 라이브 방송 판매',
    desc: '백화점 매장에서 직접 송출하는 현장 라이브 방송에 입점 브랜드 제품을 큐레이션으로 편성합니다. 시청자는 방송 중 바로 구매하고, 매장 밖 전국 고객에게 브랜드가 닿습니다. 2026년 8월 첫 방송을 시작으로 정기 운영하며, 대만·싱가포르·말레이시아 해외 라이브커머스 채널과 연계해 해외 판매까지 이어집니다.',
  },
  {
    no: '03',
    title: 'SNS·CRM 마케팅',
...
const HISTORY = [
  ...
  { year: '2026', title: '백화점 매장 확장 및 AI 마케팅 도입', desc: '백화점 편집샵 매장 본격 확장(AK백화점, 롯데 등) · 백화점 현장 라이브 방송 판매 시작 · AI 기반 데이터 마케팅 도입' },
]
...
const ROADMAP = [
  ...
  { when: '2026년 8월', what: '백화점 현장 라이브 방송 판매 시작 — 매장을 넘어 전국으로', highlight: true },
