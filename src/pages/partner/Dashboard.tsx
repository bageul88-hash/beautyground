      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div className="lg:col-span-1 bg-white rounded-[14px] border border-[#eaebee] p-6">
          <div className="flex items-center justify-between mb-5">
            ...
            <Link
              to="/partner/live/new"
              className="flex items-center gap-1 text-[12px] text-[#1a1e36] hover:underline"
            >
              <IconPlus size={13} />
              라이브 예약
            </Link>
          ...
          {scheduledLives.length === 0 ? (
            <div className="text-center py-8">
              ...
              <Link
                to="/partner/live/new"
                className="text-[12px] text-[#1a1e36] hover:underline mt-1 inline-block"
              >
                라이브 예약하기
              </Link>
            </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        {[
          ...
          <Link
            key={to}
            to={to}
            className="flex items-center justify-center gap-2 bg-white border border-[#eaebee] rounded-xl py-4 text-[13px] font-medium text-[#555] hover:border-[#1a1e36] hover:text-[#1a1e36] transition-colors"
          >
            <Icon size={18} />
            {label}
          </Link>
