...
const inputCls =
  'w-full border border-[#eaebee] rounded-lg px-3.5 py-2.5 text-[13px] text-[#111] placeholder:text-[#bbb] focus:outline-none focus:border-[#1a1e36] transition-colors bg-white'
    ...
    <div className="max-w-2xl space-y-6">
      ...
      <div className="bg-white rounded-[14px] border border-[#eaebee] p-6">
        <div className="flex items-center gap-2 mb-5">
          <IconUser size={16} className="text-[#1a1e36]" />
      ...
      <div className="bg-white rounded-[14px] border border-[#eaebee] p-6">
        <div className="flex items-center gap-2 mb-5">
          <IconLock size={16} className="text-[#1a1e36]" />
        ...
        <form onSubmit={handlePasswordChange} className="space-y-4">
          ...
          <button
            ...
            className="w-full py-2.5 bg-[#1a1e36] hover:bg-[#12142a] disabled:opacity-60 text-white font-semibold rounded-lg text-[13px] transition-colors"
          >
